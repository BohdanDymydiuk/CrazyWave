...
const textareaWrapper = document.querySelector(
  '.get-in-touch__form-textarea-wrapper');
...
button.addEventListener('click', function() {
  ...
  if (!textarea.checkValidity()) {
    ...
    textareaWrapper.classList.add(
      'get-in-touch__form-textarea-wrapper--invalid');
...
document.addEventListener('scroll', function() {
  ...
  if (currentScrollTop > lastScrollTop) {
    fadeInElementsY.forEach(element => {
      if (isInView(element)) {
        element.classList.add(
          'start-position-for-scroll-down', 'fade-in-element');
      } else {
    ...
    fadeInElementsY.forEach(element => {
      if (isInView(element)) {
        element.classList.add(
          'start-position-for-scroll-up', 'fade-in-element');
      } else {
        element.classList.remove(
          'start-position-for-scroll-up', 'fade-in-element');
      }
